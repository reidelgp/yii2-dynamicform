...
(function ($) {
  ...
  var _parseTemplate = function (widgetOptions) {
    ...
    $template
      .find("." + yiiActiveFormData.settings.errorCssClass)
      .removeClass(yiiActiveFormData.settings.errorCssClass);
    $template
      .find("." + yiiActiveFormData.settings.successCssClass)
  ...
  var _restoreSpecialJs = function (widgetOptions) {
    ...
    // "jquery.inputmask"
    var $hasInputmask = $(widgetOptionsRoot.widgetItem).find(
